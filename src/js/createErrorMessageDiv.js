export function createErrorMessageDiv() {
    ...
    errorMessage.classList = 'border border-t-0 border-red-400 rounded-b bg-red-100 px-4 py-3 text-red-700';
    errorMessage.appendChild(document.createTextNode('An error occurred while generating this plot.'));
