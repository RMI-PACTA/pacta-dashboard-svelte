...
export class trajectory_alignment {
	...
	constructor(container, data, labels, opts) {
	  ...
	  const scenarios_to_include = (typeof opts.scenarios_to_include === "undefined") ? ["STEPS", "APS", "SDS", "NZE_2050", "CurPol", "NDC-LTS",
		"1.5C-Unif", "ETP_SDS", "NZE", "IPR FPS 2021", "1.5C", "NDC_LTS", "Reference",
		"1.5\xb0C"] : opts.scenarios_to_include;
	  ...
	  function appendOptionsToTechSelector(tech_selector,data,selected_option) {
		...
		let sector_tech_grps = rollups(data_not_benchmark, v => d3.map(v, d => d.technology_translation).keys().sort(), d => d.ald_sector_translation);
