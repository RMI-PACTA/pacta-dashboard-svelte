	...
	constructor(container, data, labels, opts) {
		...
		function change_class() {
			...
			let selected_benchmark =
				typeof benchmark_selector.value === 'undefined' ? '' : benchmark_selector.value;
			let selected_allocation =
				typeof allocation_selector.value === 'undefined'
					? 'Portfolio Weight'
					: allocation_selector.value;
			let selected_market =
				typeof market_selector.value === 'undefined' ? 'Global Market' : market_selector.value;
			let selected_geo = typeof geo_selector.value === 'undefined' ? 'Global' : geo_selector.value;
			let selected_source =
				typeof source_selector.value === 'undefined' ? '' : source_selector.value;
		...
		function update() {
			...
			let scenario_select = legend_grp.selectAll(null).data(legend_data);
			scenario_select
				.enter()
				.append('rect')
				.attr('x', 0)
